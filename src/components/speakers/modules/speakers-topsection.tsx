...
export default function Speakerstopsection() {
  return (
    <section className="relative min-h-screen w-full overflow-hidden bg-[#fdf8f0]">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 py-16">
        ...
        <div className="mb-8 md:mb-12 lg:mb-16">
          <SunIcon size={130} className="w-24 h-24 md:w-28 md:h-28 lg:w-32 lg:h-32" />
        </div>

        {/* Text content */}
        <div className="text-center max-w-2xl">
          <p className="font-bilo text-xl md:text-2xl lg:text-3xl font-semibold leading-relaxed text-[#000000]">
