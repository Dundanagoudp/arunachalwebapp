                  ...
                  {navLinks.map((link, index) => (
                    ...
                    >
                      <Link
                        ...
                        className="group flex items-center px-6 py-4 text-base font-medium text-gray-700 hover:text-amber-700 hover:bg-amber-50/50 transition-all duration-300 relative overflow-hidden"
                      >
                        <motion.div
