    ...
    <div className="min-h-screen bg-[#FFF8ED] py-8 px-2 sm:py-12 sm:px-4 lg:px-8 flex flex-col items-center overflow-x-hidden font-['Inter',sans-serif]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-0 md:gap-x-24 gap-y-8 max-w-lg sm:max-w-2xl md:max-w-6xl w-full relative px-0 sm:px-2">
        ...
        <form
          ...
          className="bg-white p-6 sm:p-8 md:p-10 rounded-2xl shadow-lg border-2 border-[#1A3FA9] flex flex-col gap-6 relative z-10 w-full"
        >
          <div>
            ...
            <Input
              ...
              className="w-full border-2 border-gray-300 rounded-xl px-4 py-4 text-gray-900 focus:outline-none focus:border-[#1A3FA9] transition-colors font-medium bg-white"
              value={fullName}
          ...
          <div>
            ...
            <Textarea
              ...
              rows={5}
              className="w-full border-2 border-gray-300 rounded-xl px-4 py-4 text-gray-900 focus:outline-none focus:border-[#1A3FA9] transition-colors font-medium bg-white resize-y min-h-[120px]"
              value={description}
...
disabled={loading}
>
<span className="bg-[#D95E1E] text-white px-8 py-2 rounded-full text-base sm:text-lg font-medium">
