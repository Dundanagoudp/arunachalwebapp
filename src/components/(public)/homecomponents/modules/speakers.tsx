    ...
    <div className="min-h-0 md:min-h-screen bg-gradient-to-b from-[#FFF8E7] to-[#FFFAEE] relative overflow-x-hidden">
      ...
      <div className="container mx-auto py-8 md:py-16 px-2 md:px-4 pb-4 md:pb-16 relative z-10">
        ...
        <header className="text-center mb-8 md:mb-16">
          <p data-aos="fade-up" data-aos-delay="0" data-aos-duration="1000" className="text-[#E67E22] text-2xl md:text-3xl uppercase tracking-wider mb-2 font-dm-serif whitespace-nowrap">Arunachal Literature Festival</p>
          <h1 className="text-[#E67E22] text-3xl md:text-4xl uppercase font-semibold tracking-wide font-dm-serif">SPEAKERS</h1>
