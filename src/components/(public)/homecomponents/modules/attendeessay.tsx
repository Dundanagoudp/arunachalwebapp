...
export default function Attendeessay() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 pt-[200px] md:pt-[300px] lg:pt-[400px] pb-10 md:pb-20 lg:pb-24 flex flex-col items-center px-4 font-bilo text-base">
        {/* Header Text */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 max-w-6xl mx-auto w-full relative mb-60">
          ...
          <div className=" justify-center mb-8 ml-28">
            <Image
...
function TestimonialCard({ name, title, quote, avatar }: TestimonialCardProps) {
  return (
    <Card
      className={`rounded-4xl p-6 relative h-auto flex flex-col transition-all hover:scale-[1.02] bg-blue-800 text-white border-none font-bilo text-base`}
    >
