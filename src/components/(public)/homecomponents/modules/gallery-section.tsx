      ...
      <div className="container px-4 md:px-6 max-w-7xl mx-auto">
        <div className="relative flex flex-col items-center justify-center text-center space-y-4 mb-12">
          ...
          {isLoading ? (
            ...
            <>
              {/* <p data-aos="fade-up" data-aos-delay="0" data-aos-duration="1000" className="text-[#1A3FA9] text-xl md:text-3xl uppercase tracking-wider mb-2 font-dm-serif mt-10 font-normal md:font-semibold">Arunachal Literature Festival</p> */}
