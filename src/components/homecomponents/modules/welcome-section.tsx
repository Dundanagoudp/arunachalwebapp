...
//   return (
//     <div className="relative bg-[#fdf8f0] flex items-center justify-center py-8 sm:py-12 lg:py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
//       <div className="relative z-10 max-w-4xl mx-auto text-center lg:text-left">
//         <h1 className="text-3xl sm:text-4xl md:text-3xl font-bold text-[#1A3FA9] mb-6 md:mb-5 tracking-tight leading-tight font-serif text-center">
...
//       <div className="absolute top-0 left-0 p-4 sm:p-8 lg:p-12 hidden lg:block">
//         <Image
...
//       <div className="absolute bottom-0 left-0 p-4 sm:p-8 lg:p-12 hidden lg:block">
//         <Image
...
//       <div className="absolute top-1/2 right-0 -translate-y-1/2 p-4 sm:p-8 lg:p-12 hidden lg:block">
//         <Image
...
export default function FestivalInfo() {
  return (
    <div className="relative bg-[#fdf8f0] flex items-center justify-center py-8 sm:py-12 lg:py-8 lg:min-h-screen px-4 sm:px-6 lg:px-8 overflow-hidden">
      <div className="relative z-10 max-w-4xl mx-auto text-center lg:text-left">
        <h1 className="text-3xl sm:text-4xl md:text-3xl font-bold text-[#1A3FA9] mb-6 md:mb-5 tracking-tight leading-tight font-serif text-center">
          WELCOME TO THE HAPPIEST FESTIVAL OF INDIA
        </h1>
