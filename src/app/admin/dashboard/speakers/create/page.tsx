...
import { Mic, Save, ArrowLeft, Upload } from "lucide-react"
...
export default function CreateSpeaker() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    console.log("Creating speaker:", formData)
          ...
          <div className="flex items-center gap-2 px-4">
            ...
            <Breadcrumb>
              <BreadcrumbList>
                ...
                <BreadcrumbItem className="hidden md:block">
                  <BreadcrumbLink href="/admin/speakers">Speakers</BreadcrumbLink>
                </BreadcrumbItem>
                <BreadcrumbSeparator className="hidden md:block" />
                <BreadcrumbItem>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex gap-4">
                  ...
                  <Button type="button" variant="outline" asChild>
                    <Link href="/admin/speakers">Cancel</Link>
                  </Button>
                </div>
              </form>
            </CardContent>
